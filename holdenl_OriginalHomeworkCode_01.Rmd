...
#Installation of Packages Required for Challenges in Module 4
...
#Create a vector using a string of individual words. Assign the vector to the string of words by using the command v1 <- c("...","...")
...
#Make sure the vector is correct by typing v1

> v1

 [1] "Stately,"   "plump"      "Buck"       "Mulligan"   "came"       "from"       "the"        "stairhead,"
 [9] "bearing"    "a"          "bowl"       "of"         "lather"     "on"         "which"      "a"         
[17] "mirror"     "and"        "a"          "razor"      "lay"        "crossed."  

#str_split() takes a character vector and returns a list.

#str_split(string, pattern, n = Inf, simplify = FALSE)
#Use the code above to assign numbers to each word, so that you may extract them
...
#Extract individual words by using the number it was assigned. Ex: "lay" is assigned to number 21. Type the code v1[c(...,...,...)]
...
#Create your matrix by using the code m <- matrix(data=...:..., nrow=..., ncol+..., byrow=TRUE)

> m<- matrix(data=1:80, nrow=8, ncol=10, byrow=TRUE)

#Check that your matrix is correct by typing m
...
#Assign the columns, rows you would like to to the letter x by typing the code x <- m[c(row,column)]
...
#Check that the array is correct by typing a
...
#Extract data from the array by typing the code a[...,...]
...
#Assign each name to a string of words

> Lemuroidea<-c("Cheirogaleidae", "Lepilemuridae","Indridae", "Lemuridae", "Daubentoniidae")

> Lorisoidea<-c("Lorisidae","Galagidae")

#Assign the main category to a list by tying the code: names<-list("...","...")     
