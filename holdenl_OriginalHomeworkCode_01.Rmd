...
#create a vector using a string of individual words. Assign the vector to the string of words by doing v1 <- c("...","...")
...
#Assign x to the colmns, rows you would like to. x <- m[c(row,column)]
